...
from app.forms.forms import LoginForm, ResetPasswordForm, ResetPasswordRequestForm, RegistrationForm, EditProfileForm, EmptyForm, PostForm
...
def home():
        ...
        return render_template('index.html',title=title, form=form, 
                                ...
                                prev_url=prev_url, BlogTitle="Test")
...
def unfollow(username):
        ...
        if form.validate_on_submit():
                ...
                db.session.commit()
                flash('You are not following{}.'.form(username))
                return redirect(url_for('user', username=username))
        else:
                return redirect(url_for('home'))
