                ...
                if form2.searchData.data:
                        ...
                        if rows:
                                ...
                                for row in rows:
                                        ...
                                        print(rows)
                                        results = rows
                                        return render_template('search.html',title=title, results=results, form3=form3, BlogTitle="Test", form2=form2)
                        else:
                                error="Sorry there are no results"
                                return render_template('search.html',title=title, error=error, form3=form3, BlogTitle="Test",  form2=form2)
                return render_template('index.html',title=title, form3=form3, BlogTitle="Test",  form2=form2)
